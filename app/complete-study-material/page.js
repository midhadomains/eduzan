          ...
          <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
            <div className="lg:pr-4">
              <div className="lg:max-w-lg">
                ...
                <p className="mt-6 text-sm lg:text-xl sm:text-sm md:text-lg leading-6 text-gray-700 tracking-wide">Our comprehensive study material for the FRM® curriculum is designed to provide candidates with everything they need for a complete and thorough understanding of the subject. With a range of resources and features, we ensure that our candidates have access to the best tools for their exam preparation.</p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
            <div className="lg:pr-4">
              <div className="max-w-auto text-xl leading-7 text-gray-700 lg:max-w-lg tracking-wide">
                <p className='text-sm lg:text-xl sm:text-sm md:text-lg leading-6'>Our study material encompasses various components such as video lectures, lecture PDFs, question banks, mock tests, and past sample paper questions. These resources cover all the essential aspects of the FRM® curriculum, allowing candidates to delve into each topic with confidence.</p>
                <p className="mt-8 text-sm lg:text-xl sm:text-sm md:text-lg leading-6">The video lectures provide in-depth explanations and visual aids to enhance understanding, while the lecture PDFs serve as comprehensive guides.</p>
                <p className='mt-8 text-sm lg:text-xl sm:text-sm md:text-lg leading-6'>To ensure clarity and address any doubts, we offer instructor-led doubt sessions, where candidates can interact with experienced instructors and receive personalized guidance. Our unlimited doubt answering feature enables candidates to seek clarification on any topic.</p>
                <p className="mt-8 text-sm lg:text-xl sm:text-sm md:text-lg leading-6">With our complete study material, candidates can approach the FRM® curriculum with confidence, knowing that they have access to a wealth of resources and expert support to excel in their exams.</p>
              </div>
            </div>
          </div>
        </div>
