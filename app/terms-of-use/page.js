  ...
  return (
    <>
      ...
      <div className='align-left'>
        <div className="flex flex-col md:flex-row  pt-10 mx-12 ">
          <h2 className="text-4xl md:text-5xl text-red-950 border-l-8 border-red-950  md:mx-4 pl-4  md:pl-5 font-bold">
            Terms of Use
          </h2>
        </div>

        <div className="container grid-flow-row items-center justify-center pt-4 md:pt-8 px-4 md:px-16">
          <p className="mt-4 text-xl lg:text-lg font-normal">
            These Terms of Use set out the terms and conditions for use of this MidhaFin ( <b>“Website”</b>) and any content, Public Forums, or services offered on or through the Website and/or through any mobile application(s) ( <b>“Application”</b>) (collectively referred to as the <b>“Platform”</b>).
          </p>
          <p className="mt-4 text-xl lg:text-lg font-normal">
            These Terms of Use apply to end users of the Website (referred to as <b>“Learners”</b>, <b>“You”</b>, <b>“Your”</b>). These Terms of Use, including the Privacy Policy and any other terms and conditions published on the Platform or communicated to you from time to time (collectively referred to as the <b>“Agreement”</b>), define the relationship and responsibilities between You and Creator (as defined herein) in using the Platform. Your access to the Platform is subject to Your acceptance of this Agreement. Hence, please take Your time to read this Agreement.
          </p>
          <p className="mt-4 text-xl lg:text-lg font-normal">
            When we speak of “Creator”, <b>&apos;we&apos;</b>, <b>&apos;us&apos;</b>, and <b>&apos;our&apos;</b>, we collectively mean MidhaFin being the creator of this Platform and the content/materials/services contained therein.
          </p>
          <p className="mt-4 text-xl lg:text-lg font-normal">
          ...
          <div className="grid gap-6 mb-8 mt-4">
            <div className="min-w-0 p-4 bg-gray-100 rounded-lg shadow-l ">
              <h4 className="mb-4 font-semibold text-gray-800 text-xl lg:text-m">
                Access and Registration:
              </h4>
              <p className="text-gray-800  text-xl lg:text-base">
              ...
              <p className="text-gray-800 mt-4 text-xl lg:text-base">
            ...
            <div className="min-w-0 p-4 bg-gray-100 rounded-lg shadow-xs">
              <h4 className="mb-4 font-semibold text-gray-600 text-xl lg:text-base">
                License to Use:
              </h4>
              <p className="text-gray-800 text-xl lg:text-base">
              ...
              <div className="min-w-0 p-4 bg-gray-200 rounded-lg shadow-xs mt-4">
                <p className="text-gray-800 mt-4 text-xl lg:text-base">
            ...
            <div className="min-w-0 p-4 bg-gray-100 rounded-lg shadow-l ">
              <h4 className="mb-4 font-semibold text-gray-800 text-xl lg:text-base">
                Communications:
              </h4>
              <p className="text-gray-800 text-xl lg:text-base">
            ...
            <div className="min-w-0 p-4 bg-gray-100 rounded-lg shadow-xs">
              <h4 className="mb-4 font-semibold text-gray-600 text-xl lg:text-m">
                Code of Conduct:
              </h4>
              <p className="text-gray-800 text-xl lg:text-base">
              ...
              <div className="min-w-0 p-4 bg-gray-200 rounded-lg shadow-xs mt-4">
                ...
                <p className="text-gray-800 text-xl lg:text-base">
                  Any content which incites or promotes violence, that may cause physical or emotional harm or that may endanger the safety of any individual or is otherwise objectionable is expressly prohibited on the Platform. The Platform is to be used only for the permitted uses as detailed under this Agreement.
                </p>
              </div>
              <div className="min-w-0 p-4 bg-gray-200 rounded-lg shadow-xs mt-4">
                <h4 className="mb-4 font-semibold text-gray-600 text-xl lg:text-base">
              ...
              <div className="min-w-0 p-4 bg-gray-200 rounded-lg shadow-xs mt-4">
                ...
                <p className="text-gray-800 text-xl lg:text-base">
                  Any content, the sole objective of which is to sensationalise, shock or disturb individuals is not allowed. We do not allow any content that promotes terrorist acts or incites violence, to be uploaded on the Platform in any manner.
                </p>
              </div>
              <div className="min-w-0 p-4 bg-gray-200 rounded-lg shadow-xs mt-4">
                <h4 className="mb-4 font-semibold text-gray-600 text-xl lg:text-base">
            ...
            <div className="min-w-0 p-4 bg-gray-100 rounded-lg shadow-l ">
              <h4 className="mb-4 font-bold text-gray-800 text-xl lg:text-base">
                Disclaimer:
              </h4>
              <p className="text-gray-800 font-medium text-xl lg:text-base">
              ...
              <p className='text-gray-800 mt-4 font-medium text-xl lg:text-base'>
            ...
            <div className="min-w-0 p-4 bg-gray-100 rounded-lg shadow-l ">
              ...
              <p className="text-gray-800 text-xl lg:text-base">
                Creator has not reviewed all of the sites linked to its Platform and is not responsible for the contents of any such linked site. The inclusion of any link does not imply endorsement by the Creator of such site. Use of any such linked website is at the Your own risk.
              </p>
            </div>
            <div className="min-w-0 p-4 bg-gray-100 rounded-lg shadow-l ">
              <h4 className="mb-4 font-semibold text-gray-800 text-xl lg:text-base">
            ...
            <div className="min-w-0 p-4 bg-gray-100 rounded-lg shadow-l ">
              ...
              <p className="text-gray-800 text-xl lg:text-base">
                If You&apos;ve have concerns or queries regarding this Agreement, You may write to us by email at midhafin@gmail.com.
              </p>
            </div>
