        ...
        <div className="accordion-container pt-12 sm:pl-4 sm:pr-4 md:pl-8 md:pr-8 lg:pl-20 lg:pr-20">
            {buttonsData.map((button) => (
                <div key={button.id} className="accordion-item ">
                    <button
                        className={`accordion rounded-2xl flex items-center pl-4 pr-4 mb-4 sm:h-16 lg:h-14 p-4 text-left w-full bg-yellow-700 text-white hover:bg-orange-900 focus:outline-none focus:shadow-outline drop-shadow-lg ${selectedButton === button.id ? 'bg-gray-700' : ''
                            }`}
