...
export const metadata = {
  title: "Unlimited Access Till You Pass Your Finance Exam | MidhaFin",
  description: "Study with confidence! Our 'Access Till You Pass' program provides ongoing access to finance materials until you achieve your goal. Learn more at MidhaFin.",
  keyword: [
    "Access till you pass finance",
    "Unlimited study access",
    "Continuous study materials access",
    "Finance study resources till pass",
    "Pass guarantee study program",
    "Unlimited access finance courses",
    "Ongoing access till exam pass",
    "Finance exam preparation access",
    "Study materials till pass",
    "Finance exam success plan"
  ]
};
