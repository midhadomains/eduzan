    ...
    return (
        <div className='select-none'>
            ...
            <div className='max-w-[1400px] md:px-[50px] px-[25px] mx-auto'>
                ...
                <h1 className='md:text-[44px] sm:text-[34px] text-[24px] lg:text-[64px] font-[700] text-[#691D1C] tracking-wide sm:text-left text-center'>MidhaFin Study <span className='text-[#BE4E1E]'>Planner</span></h1>
                <div className='border flex  sm:flex-row flex-col mt-[4.5%] shadow-[0px_4px_4px_0px_#0000001F]'>
                    <div className='max-w-[650px] mx-auto w-[50%] min-w-[280px] bg-[#F9F6EB] flex justify-center items-center md:py-[49px] sm:py-[35px] py-[21px]'>
                        <Image src="/mf_planner.svg" width={800} height={800} className='w-[93%]'/>
                    </div>
                    <div className='max-w-[650px] w-[50%] min-w-[280px] mx-auto   '>
                        ...
                        <Link href="" className='flex items-center gap-2'>FRM Part 1<MdKeyboardArrowRight /></Link>
                        <Link href="" className='flex items-center gap-1.5'>FRM Part 2<MdKeyboardArrowRight /></Link>
                        </div>
                ...
                {/* <div>Know More</div>    */}
                <p className='max-w-[1000px] sm:mt-[48px] mt-[26px] md:mt-[68px] leading-[22px] md:leading-[38.8px] lg:text-[16px] text-[14px] xl:text-[20px] mx-auto'>We at MidhaFin are a strong proponent of smart work. Many FRM®, CFA & PRM students whom we have taught over the years have had to juggle their exam preparations with either job or college which brought time management & exam strategy to the forefront of their FRM®/CFA/PRM preparation.</p>
