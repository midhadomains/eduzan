...
export const metadata = {
    title: "Study Planner - MidhaFin | Get Guidance For Your Study Planning ",
    description: "Discover experiences with MidhaFin. Read reviews and testimonials from successful FRM candidates who have benefited from our expert guidance and comprehensive resources.",
    keywords: [
      "MidhaFin",
      "Study Planner",
      "FRM Study Plan",
      "FRM Exam Plan",
      "FRM Guidance",
      "Financial risk manager syllabus ",
      "frm garp study plan",
      "garp study plan",
      "study plan frm",
      "frm syllabus"
            ...
            <div className='max-w-[1400px] md:px-[50px] px-[25px] mx-auto'>
                ...
                <div className=' flex  flex-wrap mt-[4.5%] shadow-[0px_4px_4px_0px_#0000001F] rounded-[10px]'>
                    <div className='max-w-[650px]  sm:w-[50%] min-w-[280px] bg-[#F9F6EB] sm:rounded-[10px_0px_0px_10px] flex justify-center items-center md:py-[49px] sm:py-[35px] py-[21px]'>
                        <Image src="https://midha-images.s3.ap-south-1.amazonaws.com/Midhafin/public/mf_planner.webp" width={800} height={800} alt="img" className='w-[93%]'/>
                    </div>
...
>Know More <MdOutlineArrowDropDown />
                ...
                <Image src="https://midha-images.s3.ap-south-1.amazonaws.com/Midhafin/public/pf_platformx.png" height={700} width={1300} alt="img"/>
                </div>
