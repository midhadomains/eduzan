...
export default function AboutUsSlider() {
    return (
        <div className='mt-20 flex flex-nowrap border overflow-x-scroll py-3'>
            <div className='mx-3  shadow-2xl rounded-xl p-4 transition ease-in-out delay-150 bg-[#FFF5EE] hover:-translate-y-1 hover:scale-110 hover:bg-[#fffbfb] duration-300'>
            ...
            <div className=' shadow-2xl rounded-xl p-4 transition ease-in-out delay-150 bg-[#FFF5E] hover:-translate-y-1 hover:scale-110 hover:bg-[#fffbfb] duration-300'>
            ...
            <div className=' shadow-2xl rounded-xl p-4 transition ease-in-out delay-150 bg-[#FFF5EE] hover:-translate-y-1 hover:scale-110 hover:bg-[#fffbfb] duration-300'>
