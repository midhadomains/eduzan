    ...
    return (
        <div className='my-5 max-w-[1400px] px-[20px]  md:px-[50px] mx-auto'>
            <div className='flex flex-wrap-reverse justify-center md:justify-between my-5 gap-[20px] mx-auto items-center'>
                <div>
                    <button onClick={() => { setData([]); setCategory('Quantitative Analysis'); }} className='mr-4 p-2 bg-[#E8E6E2] text-[#BE4E1E] rounded-full text-[14px] md:text-[16px] px-3 md:px-6'>Quantitative Analysis</button>
                </div>
