...
function HeroSection() {
    return (
        <div className="slider-container min-h-[644px] sm:min-h-[500px] ">
            <Slide >
                <div key={1} className="flex justify-center flex-wrap lg:flex-nowrap bg-[#F9F2DF] overflow-hidden min-h-[500px] px-2  sm:px-5 sm:pt-8 pt-2">
                    <div className="max-w-[800px] my-auto flex flex-col justify-around items-center lg:items-start text-center lg:text-left	 ">
                        ...
                        <p className="lg:text-[1.75rem] md:text-[1.5rem] sm:text-[1.2rem] text-[1.1rem] md:my-7  my-3 font-[400] tracking-wide">Step up your career by acquiring the desirable skills and <span className='text-[#BE4E1E]'>leading global certifications in Finance.</span></p>
                    ...
                    <Image src="/hero-section-001.svg" alt="image" className="hidden lg:block min-w-[300px]  max-w-[500px] px-2 sm:flex-shrink-0" width={500} height={500} priority={true} />
                    <Image src="/Banner3.svg" alt="image" className="block lg:hidden min-w-[300px]  max-w-[500px] px-2 sm:flex-shrink-0 -mb-5" width={500} height={500} priority={true} />
                </div>
                <div key={1} className="h-[100%] flex justify-center flex-wrap lg:flex-nowrap bg-gradient-to-r from-[#EBD3A3] to-[#F9F2DF] overflow-hidden  px-2  sm:px-5 sm:pt-8 pt-2">
                    <div className="max-w-[700px] md:min-w-[413px] w-[40%] sm:h-auto my-auto flex flex-col justify-around items-center lg:items-start text-center lg:text-left min-w-[330px] sm:min-w-[400px] ">
