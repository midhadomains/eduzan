...
function HeroSection() {
    return (
        <div className="slider-container min-h-[644px] sm:min-h-[500px] w-[100%]">
            <Slide >
                <div key={1} className="flex justify-center flex-wrap lg:flex-nowrap bg-[#F9F2DF] overflow-hidden min-h-[500px] h-[100%]  px-2  sm:px-5 sm:pt-8 pt-2 w-[100%]">
                    ...
                    <Image src="/Banner4.svg" alt="image" className=" min-w-[300px]  max-w-[500px] px-2 sm:flex-shrink-0 -mb-5 " width={500} height={500} priority={true} />                </div>
