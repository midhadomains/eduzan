...
//     return (
//         <div>
//             <div className='max-w-full sm:flex justify-center bg-[#FAF4F2] p-2 sm:p-5 text-center '>
//                 <div className='flex flex-col item-center  justify-around w-[100%]  mx-auto '>
//                     {/* add {typeEffect} instead  of Finance  */}
//                     <div className='mx-auto'>
//                         <h1 className=' text-[25px] sm:text-[28px] text-left md:text-[30px] lg:text-[40px] xl:text-[45px] font-bold shadow-[rgba(0, 0, 0, 0.24) 0px 3px 8px;'><span className='text-[#6A1C1A]'>Boost your career </span> in  <span className='text-[#6A1C1A]'>{typeEffect} <br/></span> </h1>
//                         <h1 className=' text-[25px] sm:text-[28px] text-left md:text-[30px] lg:text-[40px] xl:text-[45px] font-bold shadow-[rgba(0, 0, 0, 0.24) 0px 3px 8px;'><span className='text-[#6A1C1A]'></span> with  mentorship you can bank on <span className='text-[#6A1C1A]'>!</span></h1>
//                     </div>
//                     <p className='text-[#391601] text-center text-[1rem] sm:text-lg  lg:text-xl mx-auto '>Step up your career by acquiring the desirable skills <br/>and leading global certifications in Finance.</p>
//                     <div className='flex mt-5 justify-center'>
//                         <Link href="https://midhafin.ongraphy.com/s/authenticate" >
...
//                     </div>
//                 </div>
//                 <div className='my-auto w-[300px] sm:w-[400px] lg:w-[600px] xl:w-[700px] mx-auto sm:mr-auto sm:my-3'>
//                     <Image width={500} height={300} className='h-auto my-auto' src="/Micky-Banner.png" alt="Micky Midha" priority />
//                 </div>
//             </div>
//         </div>
//     )
        ...
        <div>
            <div className='max-w-full sm:flex justify-center bg-[#FAF4F2] p-5 text-center'>
                <div className='flex flex-col item-center m-5 justify-around sm:w-[60%] lg:w-[45%] w-[100%]  mx-auto '>
                    {/* add {typeEffect} instead  of Finance  and add text left*/}
