...
export const generateSitemap = async (excludeSlugs = ['/api/sitemap', '/api/robots', '/thank-you', '/_not-found', '/career', '/api/comment', '/api/form', '/revalidate'], excludePages = ['/api/sitemap', '/api/robots', '/thank-you', '/_not-found', '/career', '/api/comment', '/api/form', '/revalidate']) => {
