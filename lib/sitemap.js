...
export const generateSitemap = async (excludeSlugs = ['/api/sitemap', '/api/robots', '/thank-you', '/thank-you', '/_not-found'], excludePages = ['/api/sitemap', '/api/robots', '/thank-you', '/_not-found']) => {
